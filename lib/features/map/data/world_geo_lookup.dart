...
String continentForCountry(String country) {
  ...
  const europe = {
    'albanien', 'andorra', 'belgien', 'bosnien', 'bosnien und herzegowina',
    'bulgarien', 'dänemark', 'deutschland', 'england', 'estland', 'finnland',
    'frankreich', 'griechenland', 'irland', 'island', 'italien', 'kroatien',
    'kosovo', 'lettland', 'litauen', 'luxemburg', 'malta', 'montenegro',
    'niederlande', 'norwegen', 'österreich', 'polen', 'portugal', 'rumänien',
    'schweden', 'schweiz', 'serbien', 'slowakei', 'slowenien', 'spanien',
    'tschechien', 'türkei', 'ungarn', 'vereinigtes königreich', 'zypern',
    'uk', 'great britain', 'united kingdom', 'germany', 'italy', 'spain',
    'france', 'austria', 'switzerland', 'netherlands', 'kosova',
  };
  const northAmerica = {
    'kanada', 'mexiko', 'usa', 'vereinigte staaten',
    'vereinigte staaten von amerika', 'canada', 'mexico', 'united states',
  };
  const southAmerica = {
    'argentinien', 'bolivien', 'brasilien', 'chile', 'ecuador', 'kolumbien',
    'peru', 'uruguay', 'venezuela', 'brazil', 'argentina', 'colombia',
  };
  const asia = {
    'china', 'indien', 'indonesien', 'israel', 'japan', 'katar', 'malaysia',
    'singapur', 'südkorea', 'thailand', 'vereinigte arabische emirate',
    'vietnam', 'india', 'qatar', 'singapore', 'south korea',
  };
  const africa = {
    'ägypten', 'marokko', 'südafrika', 'tunesien', 'egypt', 'morocco',
